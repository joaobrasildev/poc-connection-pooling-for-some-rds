// Package metrics define as métricas Prometheus para o proxy.
// Este é um placeholder que registra todos os coletores de métricas antecipadamente
// para que fases futuras possam usá-los sem modificar este arquivo.
package metrics
...
var (
	// ConnectionsActive rastreia o número de conexões ativas por bucket.
	...
	// ConnectionsIdle rastreia o número de conexões idle por bucket.
	...
	// ConnectionsPinned rastreia o número de conexões pinadas por bucket.
	...
	// ConnectionsMax rastreia o máximo de conexões configuradas por bucket.
	...
	// ConnectionsTotal conta o total de operações de acquire/release de conexão.
	ConnectionsTotal = promauto.NewCounterVec(prometheus.CounterOpts{
		Name: "proxy_connections_total",
		Help: "Total connection operations",
	}, []string{"bucket_id", "status"})

	// QueueLength rastreia o comprimento atual da fila por bucket.
	QueueLength = promauto.NewGaugeVec(prometheus.GaugeOpts{
		Name: "proxy_queue_length",
		Help: "Number of requests waiting in queue per bucket",
	}, []string{"bucket_id"})

	// QueueWaitDuration rastreia o tempo que requisições passam esperando na fila.
	...
	// TDSPacketsTotal conta pacotes TDS por direção e tipo.
	...
	// QueryDuration rastreia o tempo de execução de queries.
	...
	// ConnectionErrors conta erros de conexão por tipo.
	...
	// PinningDuration rastreia quanto tempo as conexões ficam pinadas.
